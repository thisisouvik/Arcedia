...
export default function InstitutionSolutionsPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-teal-50 to-cyan-50">
            ...
            <section className="container mx-auto px-4 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    <Card className="p-8 border border-gray-200 hover:shadow-xl transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-3">Bulk Upload</h3>
                    ...
                    <Card className="p-8 border border-gray-200 hover:shadow-xl transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-3">One-Click Minting</h3>
                        <p className="text-gray-600 leading-relaxed">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="flex items-start space-x-6">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Upload Credentials</h3>
                        ...
                        <div className="flex items-start space-x-6">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Review & Approve</h3>
                                <p className="text-gray-600 text-lg leading-relaxed">
                        ...
                        <div className="flex items-start space-x-6">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Mint to Blockchain</h3>
                                <p className="text-gray-600 text-lg leading-relaxed">
            ...
            <section className="container mx-auto px-4 py-20">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Reduce Administrative Costs</h3>
                    ...
                    <div className="flex items-start space-x-4">
                        <CheckCircle className="w-6 h-6 text-teal-600 mt-1 flex-shrink-0" />
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Enhance Institution Reputation</h3>
                            <p className="text-gray-600">
                    ...
                    <div className="flex items-start space-x-4">
                        <CheckCircle className="w-6 h-6 text-teal-600 mt-1 flex-shrink-0" />
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Prevent Fraud</h3>
                            <p className="text-gray-600">
            ...
            {/* CTA Section */}
            <section className="container mx-auto px-4 py-20">
                <div className="bg-gradient-to-br from-teal-600 to-cyan-600 rounded-3xl p-12 md:p-16 text-center text-white">
